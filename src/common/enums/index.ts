...
export { AccionAuditoriaEnum } from "./accion-auditoria.enum";
...
export { RolesValidosEnum } from "./roles-validos.enum";
export { TipoPuntoColeccionEnum } from "./tipo-punto-coleccion.enum";
export { TurnoEnum } from "./turno.enum";